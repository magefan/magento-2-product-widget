...
<a href="https://magefan.com/magento-2-product-widget"><img width="190" height="70" src="https://cm.magefan.com/wysiwyg/products/download-magefan-extensions.png"></a>

## Useful Links
  * [User Guide](https://magefan.com/magento-2-product-widget/documentation)
  * [Change Log](https://magefan.com/magento-2-product-widget/change-log)
  * [FAQs](https://magefan.com/magento-2-product-widget#pattr-faq)
...
<table>
  <tbody>
    ...
    <tr>
      <td align="center" valign="middle">
        <a href="https://pwa.demo.magefan.top/">
          <img
            src="https://magefan.com/static/version1520969775/frontend/Magefan/new/en_US/images/product-tab-demo-1.jpg"
            alt="Magento 2 Product Widget Extension Storefront Demo"
            height="220"
          >
        </a>
      </td>
      <td align="center" valign="middle">
        <a href="https://pwa.demo.magefan.top/admin/admin/">
          <img
            ...
            alt="Magento 2 Product Widget Extension Admin Panel Demo"
            height="220"
          >
        </a>
      </td>
